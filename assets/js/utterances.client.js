(()=>{
        ...
        // section.insertAdjacentHTML('beforeend', `<div class="utterances">\n    <iframe class="utterances-frame" title="Comments" scrolling="no" src="${h}?${new URLSearchParams(i)}" loading="lazy"></iframe>\n  </div>`);
...
const getIframeSrc = function() {
    ...
    n && (localStorage.setItem("utterances-session", n),
        t.searchParams.delete("utterances"),
        history.replaceState(void 0, document.title, t.href));

    let r = document.querySelector('script[src^="http://bruce.bugmakers.club/assets/js/utterances.client.js"],script[src^="http://localhost:3000/assets/js/utterances.client.js"]')
    ...
    document.head.insertAdjacentHTML("afterbegin", "<style>\n    .docsify-utterances-container {\n      box-sizing: border-box;\n      max-width: 80%;\n      margin: 0 auto;\n    }\n    .docsify-utterances-container-frame {\n      color-scheme: light;\n      position: absolute;\n      border: none!important;\n      left: 0;\n      right: 0;\n      width: 1px;\n      min-width: 80%;\n      max-width: 100%;\n      height: 100%;\n      border: 0;\n    }\n  </style>");


    console.log(i)

    const src = 'https://utteranc.es/utterances.html' + '?' + new URLSearchParams(i);
    return src;
}
